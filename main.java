...
public class main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String rutaPronostico = "C:/Users/lourd/OneDrive/Documentos/ENTREGA_1/pronosticoE2.csv"; // ruta del archivo de pronóstico
        String rutaResultados = "C:/Users/lourd/OneDrive/Documentos/ENTREGA_1/resultadosE2.csv"; // ruta del archivo de resultados
        ...
        try (BufferedReader lector2 = new BufferedReader(new FileReader(rutaResultados))) {
            ...
            while ((linea2 = lector2.readLine()) != null) {
                ...
                int ronda = Integer.parseInt(partes2[0]);
                String Equipo1 = partes2[1];
                int GolesE1 = Integer.parseInt(partes2[2]);
                int GolesE2 = Integer.parseInt(partes2[3]);
                String Equipo2 = partes2[4];
